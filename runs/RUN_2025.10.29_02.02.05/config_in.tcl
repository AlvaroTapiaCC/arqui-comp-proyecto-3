...
set ::env(CORE_AREA) "10 10 390 390"

# Usar una configuración de PDN más ligera para facilitar el enrutado de potencia
# Nota: variable moderna es FP_PDN_CFG (PDN_CFG está deprecado)
set ::env(FP_PDN_CFG) $::env(SCRIPTS_DIR)/openroad/pdn_cfg_lite.tcl
